  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="table-view" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="?page=tabel_kwalifikasi" class="active">
  ...
  <section class="section">
    ...
    ?>
            <div class="card" style="position:fixed; top: 50%; transform:translate(-50%, -50%); left:50%; z-index: 1000; width: 75vw">
              <div class="card-body">
                <h5 class="card-title d-flex justify-content-between"><span style="color: black;">Form Kereta</span> <a href="?page=tabel_kwalifikasi" style="color: black; text-decoration:none;"><i class="bi bi-x-circle"></i></a></h5>
